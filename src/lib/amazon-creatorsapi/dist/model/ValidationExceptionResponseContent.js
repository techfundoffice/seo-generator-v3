 ...
 * @version 1.0.0
 */
var ValidationExceptionResponseContent = /*#__PURE__*/function () {
  /**
   ...
   */
  function ValidationExceptionResponseContent(message, reason) {
    _classCallCheck(this, ValidationExceptionResponseContent);
   ...
   */
  return _createClass(ValidationExceptionResponseContent, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ValidationExceptionResponseContent.RequiredProperties),
        _step;
      try {
      ...
      if (data['fieldList']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['fieldList']),
          _step2;
        try {

 ...
 * @version 1.0.0
 */
var GetReportRequestContent = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetReportRequestContent</code>.
   * @alias module:model/GetReportRequestContent
   * @param filename {String} 
   */
  function GetReportRequestContent(filename) {
    _classCallCheck(this, GetReportRequestContent);
   ...
   */
  return _createClass(GetReportRequestContent, null, [{
    key: "initialize",
    value: function initialize(obj, filename) {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetReportRequestContent.RequiredProperties),
        _step;
      try {

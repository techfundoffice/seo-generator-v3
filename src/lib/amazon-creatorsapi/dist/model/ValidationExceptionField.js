 ...
 * @version 1.0.0
 */
var ValidationExceptionField = /*#__PURE__*/function () {
  /**
   ...
   */
  function ValidationExceptionField(name, message) {
    _classCallCheck(this, ValidationExceptionField);
   ...
   */
  return _createClass(ValidationExceptionField, null, [{
    key: "initialize",
    value: function initialize(obj, name, message) {
      obj['name'] = name;
      obj['message'] = message;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ValidationExceptionField.RequiredProperties),
        _step;
      try {

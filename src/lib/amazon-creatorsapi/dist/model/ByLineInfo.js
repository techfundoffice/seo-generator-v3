 ...
 * @version 1.0.0
 */
var ByLineInfo = /*#__PURE__*/function () {
  /**
   ...
   */
  function ByLineInfo() {
    _classCallCheck(this, ByLineInfo);
   ...
   */
  return _createClass(ByLineInfo, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      if (data['contributors']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['contributors']),
          _step;
        try {
